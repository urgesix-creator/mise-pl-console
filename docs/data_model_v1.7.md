# KOGAホールディングス海外飲食店 売上管理システム データモデル設計書 v1.7

| 項目 | 内容 |
|---|---|
| プロジェクト名 | KOGAホールディングス海外飲食店 売上管理システム |
| ドキュメント | データモデル設計書 |
| バージョン | v1.7（売上計算の制度変更：net_sales を主入力に、gross_sales を独立入力に再定義。税込／ランチ／ディナーはネットと非連動。整合性チェックを桁違い警告のみに緩和） |
| 作成日 | 2026年5月10日（v1.7改訂：2026年5月30日） |
