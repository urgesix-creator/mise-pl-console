...
<body>
  <div class="container">
    <div class="header">
      <div class="logo">Sales Console · KOGA Holdings</div>
    </div>
    <div class="content">
      ${innerContent}
    </div>
    <div class="footer">
      © 2026 KOGA Holdings Co., Ltd.
    </div>
  </div>
</body>
</html>`;
...
const INVITATION: Record<Locale, (v: EmailVariables) => EmailRenderResult> = {
  ja: (v) => ({
    subject: 'Sales Console へのご招待',
    html: wrapHtml(`
      <h1 class="h1">Sales Console へようこそ</h1>
      <p class="p">${v.displayName} 様</p>
      <p class="p">
        ${v.inviterName} 様より、KOGAホールディングス Sales Console へのアカウント招待が届いています。
...
— Sales Console / KOGA Holdings`,
  }),

  en: (v) => ({
    subject: "You're invited to Sales Console",
    html: wrapHtml(`
      <h1 class="h1">Welcome to Sales Console</h1>
      <p class="p">Hi ${v.displayName},</p>
      <p class="p">
        ${v.inviterName} has invited you to join KOGA Holdings Sales Console.
...
— Sales Console / KOGA Holdings`,
  ...
  th: (v) => ({
    subject: 'คุณได้รับเชิญเข้าใช้ Sales Console',
    html: wrapHtml(`
      <h1 class="h1">ยินดีต้อนรับสู่ Sales Console</h1>
      <p class="p">เรียน คุณ ${v.displayName}</p>
      <p class="p">
        ${v.inviterName} ได้เชิญคุณเข้าร่วมระบบ KOGA Holdings Sales Console
    ...
    `),
    text: `ยินดีต้อนรับสู่ Sales Console
...
— Sales Console / KOGA Holdings`,
  ...
  id: (v) => ({
    subject: 'Anda diundang ke Sales Console',
    html: wrapHtml(`
      <h1 class="h1">Selamat datang di Sales Console</h1>
      <p class="p">Yth. ${v.displayName},</p>
      <p class="p">
        ${v.inviterName} telah mengundang Anda untuk bergabung dengan KOGA Holdings Sales Console.
    ...
    `),
    text: `Selamat datang di Sales Console
...
const PASSWORD_RESET: Record<Locale, (v: EmailVariables) => EmailRenderResult> = {
  ja: (v) => ({
    subject: 'パスワードリセットのご案内 - Sales Console',
    html: wrapHtml(`
...
— Sales Console / KOGA Holdings`,
  ...
  en: (v) => ({
    subject: 'Reset your password - Sales Console',
    html: wrapHtml(`
...
— Sales Console / KOGA Holdings`,
  ...
  th: (v) => ({
    subject: 'รีเซ็ตรหัสผ่านของคุณ - Sales Console',
    html: wrapHtml(`
...
— Sales Console / KOGA Holdings`,
  ...
  id: (v) => ({
    subject: 'Atur ulang kata sandi Anda - Sales Console',
    html: wrapHtml(`
